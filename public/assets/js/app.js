...
!(function (r) {
    ...
    function t(e) {
        ...
        "light-mode-switch" === e
            ...
            ? (r("html").removeAttr("dir"),
              ...
              r("#app-style").attr("href", "assets/css/app-dark.min.css"),
    ...
    function e() {
        document.webkitIsFullScreen ||
            ...
            (console.log("pressed"),
            r("body").removeClass("fullscreen-enable"));
    }
    var a;
    r("#side-menu").metisMenu(),
        ...
        r(document).ready(function () {
            ...
            0 < r("#sidebar-menu").length &&
                ...
                300 <
                    (e = r("#sidebar-menu .mm-active .active").offset().top) &&
                ((e -= 300),
                r(".simplebar-content-wrapper").animate(
                    { scrollTop: e },
                    "slow"
                ));
        }),
        ...
        (function () {
            ...
            var a = r(this).attr("data-delay")
                    ? r(this).attr("data-delay")
                    : 100,
                n = r(this).attr("data-time")
                    ? r(this).attr("data-time")
                    : 1200;
            r('[data-plugin="counterup"]').each(function (e, t) {
                r(this).counterUp({ delay: a, time: n });
            });
        })(),
        ...
        (function () {
            ...
            e &&
                ...
                r("#header-chart-1").sparkline(t, a),
                ChartColorChangeSparkLine(t, a, "header-chart-1"));
            var t,
                a,
                n = getChartColorsArray("header-chart-2");
            n &&
                ((t = [8, 6, 4, 7, 10, 12, 7, 4, 9, 12, 13, 11, 12]),
                (a = {
                    type: "bar",
                ...
                r("#header-chart-2").sparkline(t, a),
                ChartColorChangeSparkLine(t, a, "header-chart-2"));
        })(),
