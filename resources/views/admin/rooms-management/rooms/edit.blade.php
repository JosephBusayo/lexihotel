@extends('layouts.app', ['page' => 'admin.room-management.edit-room'])
...
@section('content')
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-body">
          <h4 class="card-title mb-3">Editing Room</h4>
          <form action="{{ route('admin.room.update', $room->uid) }}" method="POST" class=""
