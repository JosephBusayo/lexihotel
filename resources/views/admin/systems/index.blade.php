@extends('layouts.app', ['page' => 'admin.system.index'])
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('admin.system.store') }}" method="POST" class="" enctype="multipart/form-data">
            <div class="row">
              @csrf
              @include('admin.systems._form')
            </div>
